...
export default function MyAppBar({ handleCountryChange }) {
  let [countries, settotalCountries] = React.useState(0);
  ...
  const handleChange = (country) => {
    console.log("MyappBa chọn:", country);
    handleCountryChange(country);
  };
  const totalCountries = (totalCountries) => {
    //console.log("My App totalCountries:", totalCountries);
                ...
                <ul className="menu">
                  <li>
                    <a href="/some/valid/uri#top">
                      <Link to="/thongKe">Trang chủ</Link>
                    </a>
                  </li>
                  <li>
                    <a href="/some/valid/uri#top">
